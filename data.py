...
class SuperTrack:
    def __init__(self, device):
        ...
        world_state_dict = torch.load('/root/SuperTrack/pretrain2_model/epoch_69_world.pth')
        policy_state_dict = torch.load('/root/SuperTrack/pretrain2_model/epoch_69_policy.pth')
    ...
    def train(self):
        ...
        for epoch in range(self.EPOCH):
            ...
            for data in tqdm(self.train_dataloader):
                ...
                self.policy_optimizer.zero_grad()
                loss.backward()
                grad_norm = torch.nn.utils.clip_grad_norm_(self.policy.parameters(), 25.0)
